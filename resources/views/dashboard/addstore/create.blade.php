        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{route('addstore.store')}}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" value="{{old('store_name')}}" name="store_name" id="store_name" data-validation="required" class="form-control ">
                            </div>

                            <div class="form-group col-md-3">

                                <label for="store_mobile">@lang('site.mobile')</label>
                                <input type="text" value="{{old('store_mobile')}}" name="store_mobile" id="store_mobile" data-validation="required" class="form-control ">
                            </div>

                            <div class="form-group col-md-3">

                                <label for="store_address">@lang('site.address')</label>
                                <input type="text" value="{{old('store_address')}}" name="store_address" id="store_address" data-validation="required" class="form-control ">
                            </div>
