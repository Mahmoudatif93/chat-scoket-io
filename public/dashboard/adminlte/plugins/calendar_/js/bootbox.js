...
! function(a, b) {
    ...
    var n = {
            dialog: "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-header'><button type='button' class='bootbox-close-button close' data-dismiss='modal' aria-hidden='true'>×</button><h4 class='modal-title'>تفاصيل الزيارة:</h4></div><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
