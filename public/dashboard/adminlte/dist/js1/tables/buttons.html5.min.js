...
var arraytext = locarray[1];

*/



var arraytext =location.protocol+'//'+ window.location.hostname + '/' + location.pathname.split('/')[1]+ '/';
...
(function(j) {
    ...
    m.ext.buttons.copyHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.copy", "<i class='fa fa-copy blue'> </i> نسخ")
        },
    ...
    m.ext.buttons.csvHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.csv", "<i class='fa fa-file-o yellow'> </i> CSV")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            a = G(c, b).str;
    ...
    m.ext.buttons.excelHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.excel", "<i class='fa fa-file-excel-o green'> </i> Excel")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var e = this,
            ...
            for (var c = 0, s = d.body.length; c < s; c++) i(d.body[c],
                f);
    ...
    m.ext.buttons.pdfHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.pdf", "<i class='fa fa-file-pdf-o red'> </i> PDF")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var e = this,
                ...
                f = c.buttons.exportInfo(b),
                c = [];
            b.header && c.push(j.map(a.header,
                function(a) {
                    return {
