...
(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" style="width:40%" class="' + b.sFilterInput + ' no-margin"/> <button type="button"  class=" btn btn-default  w-md no-margin "  id="addSearchInputs" ><i class="fa fa-search"></i> بحث متقدم  </button>',
            j = d.sSearch,
            j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g,
            b = h("<div/>", {
                id: !f.f ? c + "_filter" : null,
                "class": b.sFilter
            }).append(h("<div/>").append(j)),
            f = function() {
                var b = !this.value ?
                    "" : this.value;
                b != e.sSearch && (ga(a, {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "لا توجد بيانات متاحة فى الجدول",
            sInfo: "عرض _START_ الى _END_ من _TOTAL_ من البيانات",
            sInfoEmpty: "عرض 0 الى 0 من 0 مدخلات",
            sInfoFiltered: "(فلتر من  _MAX_ اجمالى الصفوف)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",", 
            sLengthMenu: "عرض _MENU_ من الصفوف فى الصفحة",
            sLoadingRecords: "<div class='loader-img'><div class='bar1'></div><div class='bar2'></div><div class='bar3'></div><div class='bar4'></div><div class='bar5'></div><div class='bar6'></div></div>",
            sProcessing: "قيد التقدم...",
            sSearch: "بحث :",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "لا توجد نتائج لبحثك , استخدم كلمات أخرى"
        },
