	...
	var MDTimePicker = function (input, config) {
		...
		this.timepicker = {
			...
			timeHolder : {
				...
				am_pm: $('<span class="mdtp__ampm">ص</span>')
			},
			clockHolder : {
				...
				buttonsHolder : {
					...
					btnOk : $('<button class="mdtp__button ok btn btn-success">تم</button>'),
					btnCancel: $('<button class="mdtp__button cancel btn btn-danger" style="float:left">إلغاء</button>')
				}
			}
		};
